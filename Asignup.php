...
if($_SESSION['validate'] == 'invalid' || empty($_SESSION['validate'])){
        $_SESSION['validate'] = 'invalid';
        echo "<script>window.location.href = 'http://localhost/finals/Avalidation.php'</script>";
 ...
 if(isset($_POST['submit'])){
        ...
        if (!in_array($username,$existedUsername)){
            ...
            $sql = "INSERT INTO `admin`(`username`, `password`, `email`, `fname`, `lname`) VALUES ('$username','$password','$email','$fname','$lname')";
            ...
            if($result){
                ob_start();
                $_SESSION['validate'] = 'invalid';
                echo '<script>alert("Create Successfully, Try Logging In Now!")</script>';
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="col 12 text-center text-white mt-3">
                    <p>Click to Back <a href="Alogin.php" class="link-offset-light">Log In Page</a></p>
                </div>
