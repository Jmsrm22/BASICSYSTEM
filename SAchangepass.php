<?php
	...
	if($_SESSION['SAforgot'] == 'invalid' || empty($_SESSION['SAforgot'])){
        ...
        unset($_SESSION['SAforgotID']);
        echo "<script>window.location.href = 'http://localhost/finals/SAforgot.php'</script>";
    }

    $ID = $_SESSION['SAforgotID'];
     ...
     if(isset($_POST['submit'])){
        ...
        $check = "SELECT * FROM `sadmin` WHERE `ID` = '".$ID."' ";
        ...
        $password = $_POST['password'];
         ...
         if(!in_array($username,$existedUsername) || $username == $Getusername){
            ...
            $sql = "UPDATE `sadmin` SET `username`='$username',`password`='$password' WHERE `ID` = '$GetID'";
...
<body class="bg-image">
    ...
    <div class="container-fluid">
        ...
        <div class="col 12 text-center text-white mt-3">
            <p>Click Back to <a href="Sadmin.php" class="link-offset-light">Log In Page.</a></p>
        </div>
