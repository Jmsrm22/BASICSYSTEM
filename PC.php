...
<head>
    ...
    <title>Passenger's Complaint</title>
...
<!-- Function-->
    ...
    <div class="container mt-5">
        ...
        <div class="panel-body">
            <?php 
                include "connection.php";
                $query = "SELECT * FROM `passenger_driver`  ";
                $result = mysqli_query($con,$query);
            ?>

             <h5 class="text-white text-center mb-4">PASSENGER COMPLAINTS<h5>
                ...
                <table class="table">
                    <thead class="table-dark">
                        ...
                        if (mysqli_num_rows($result) > 0 ){
                            ...
                            <tr>
                                <td data-label="Complaint No."><?php echo $row['PID']; ?></td>
                                <td data-label="Date of Accident"><?php echo $row['Pdate']; ?></td>
                                <td data-label="Complainant Name"><?php echo $row['Pname']; ?></td>
                                <td data-label="Cellphone Number"><?php echo $row['Pcpnumber']; ?></td>
                                <td data-label="Action">

                                
                                    <button style="height:35px;" data-another='<?php echo $ID?>' data-id='<?php echo $row['PID'];?>' class="userinfo btn btn-success">Complaint</button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Passenger Complaint</h4>
