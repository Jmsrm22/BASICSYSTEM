...
session_start();
 ...
 if($_SESSION['validate'] == 'invalid' || empty($_SESSION['validate'])){
    ...
    if($_SESSION['validate'] == 'valid'){
        echo "<script>window.location.href = 'http://localhost/finals/Asignup.php'</script>";
    }
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="inputBox mb-3">
                                    <h5>President Code</h5>
                                    <p>In accordance with the Costoda president, the code will be provided to enable the admin to create an account.</p> 
